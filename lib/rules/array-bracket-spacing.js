        ...
        */
        function reportNoBeginningSpace(node, token) {
            context.report({
                node: node,
                loc: token.loc.start,
                message: this.meta.errors.extraSpaceAfter,
                data: {
                    token: token.value
                },
                fix: function(fixer) {
        ...
        */
        function reportNoEndingSpace(node, token) {
            context.report({
                node: node,
                loc: token.loc.start,
                message: this.meta.errors.extraSpaceBefore,
                data: {
                    token: token.value
                },
                fix: function(fixer) {
        ...
        */
        function reportRequiredBeginningSpace(node, token) {
            context.report({
                node: node,
                loc: token.loc.start,
                message: this.meta.errors.spaceAfter,
                data: {
                    token: token.value
                },
                fix: function(fixer) {
        ...
        */
        function reportRequiredEndingSpace(node, token) {
            context.report({
                node: node,
                loc: token.loc.start,
                message: this.meta.errors.spaceBefore,
                data: {
                    token: token.value
                },
                fix: function(fixer) {
